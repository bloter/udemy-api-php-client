...
/**
 * A class to contain the library configuration for the Udemy API client.
 */
class Udemy_Config
{
  ...
  /**
   * Create a new Udemy_Config. Can accept an ini file location with the
  ...
  public function __construct($ini_file_location = null)
  {
    $this->configuration = array(
      ...
      //'auth_class'    => 'Udemy_Auth_OAuth2',
      'auth_class'    => 'Udemy_Auth_Simple2',
      'io_class'      => self::USE_AUTO_IO_SELECTION,
      'cache_class'   => 'Udemy_Cache_File',
      'logger_class'  => 'Udemy_Logger_Null',

      // Don't change these unless you're working against a special development
      // or testing environment.
      'base_path' => 'https://www.udemy.com',

      // Definition of class specific values, like file paths and so on.
      'classes' => array(
        'Udemy_IO_Abstract' => array(
        ...
        'Udemy_Logger_Abstract' => array(
          'level' => 'debug',
          'log_format' => "[%datetime%] %level%: %message% %context%\n",
          'date_format' => 'd/M/Y:H:i:s O',
          'allow_newlines' => true
        ),
        'Udemy_Logger_File' => array(
          'file' => 'php://stdout',
          'mode' => 0640,
          'lock' => false,
        ),
        'Udemy_Http_Request' => array(
        ...
        'Udemy_Cache_File' => array(
          'directory' => sys_get_temp_dir() . '/Udemy_Client'
        ),
        
		'Udemy_Auth_Simple2' => array(
          'client_id' => '',
          'client_secret' => '',
        )
      ),
