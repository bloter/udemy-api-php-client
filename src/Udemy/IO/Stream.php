...
/**
 * Http Streams based implementation of Udemy_IO.
 *
 */
...
class Udemy_IO_Stream extends Udemy_IO_Abstract
{
  ...
  public function executeRequest(Udemy_Http_Request $request)
  {
    ...
    if ($this->trappedErrorNumber) {
      ...
      throw new Udemy_IO_Exception($error, $this->trappedErrorNumber);
    }
    ...
    if (false === $response_data) {
      ...
      $this->client->getLogger()->error('Stream ' . $error);
      throw new Udemy_IO_Exception($error, $respHttpCode);
    }
