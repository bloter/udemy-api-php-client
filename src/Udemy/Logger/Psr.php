 ...
 * with the `Udemy_Logger_Psr::setLogger()` method.
 */
class Udemy_Logger_Psr extends Udemy_Logger_Abstract
{
  /**
   ...
   */
  public function __construct(Udemy_Client $client, /*Psr\Log\LoggerInterface*/ $logger = null)
  {
